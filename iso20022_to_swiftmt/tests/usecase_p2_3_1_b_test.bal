...
isolated function testP231b(xml mx, string mt) returns error? {
    ...
    test:assertEquals((check swiftmt:getFinMessage(rec)).toString(), mt, msg = "Use case p.2.3.1.b result incorrect");
}
...
string finMessage_231b_D_A = "{1:F01CLYDGB2SXXXX0000000000}{2:O1990935221020BSCHGB2LXXXX00000000002210200935N}{3:{121:7a562c67-ca16-48ba-b074-65581be6f001}}{4:\r\n" +
    ":20:pacs002bizmsgid+\r\n" +
    ":21:pcs008bzmsgidr-1\r\n" +
    ":79:/REJT/99\r\n" +
    "/AC04/\r\n" +
...
string finMessage_231b_D_C = "{1:F01BSCHESMMXXXX0000000000}{2:O2991000221020BSCHGB2LXXXX00000000002210201000N}{3:{121:7a562c67-ca16-48ba-b074-65581be6f001}}{4:\r\n" +
    ":20:pacs002bizmsgid+\r\n" +
    ":21:pacs9bizmsgidr03\r\n" +
    ":79:/REJT/99\r\n" +
    "/AC04/\r\n" +
...
string finMessage_231b_C_D = "{1:F01BSCHGB2LXXXX0000000000}{2:O2020945221020BSCHESMMXXXX00000000002210200945N}{3:{119:COV}{121:7a562c67-ca16-48ba-b074-65581be6f001}}{4:\r\n" +
    ":20:pacs9bizmsgidr03\r\n" +
    ":21:pacs008EndToEnd+\r\n" +
    ":32A:221020DKK591636,\r\n" +
    ":52A:CLYDGB2S\r\n" +
