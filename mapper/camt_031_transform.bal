...
isolated function transformCamt031ToMT196(camtIsoRecord:Camt031Document document) returns swiftmt:MTn96Message|error => {
    ...
    block1: check createMtBlock1FromSupplementaryData(document.RjctInvstgtn.SplmtryData),

    // Step 2: Create Block 2 with mandatory fields
    block2: check createMtBlock2FromSupplementaryData("196", document.RjctInvstgtn.SplmtryData),
