...
isolated function testC10621a(xml mx, string mt) returns error? {
    ...
    test:assertEquals((check swiftmt:getFinMessage(rec)).toString(), mt, msg = "Use case c.106.2.1.a result incorrect");
}
...
string finMessage_10621a_p008_B_C = "{1:F01RZBRROBUXXXX0000000000}{2:O1031055221020INGBROBUXXXX00000000002210201055N}{3:{121:7a562c67-ca16-48ba-b074-65581be6f001}}{4:\r\n" +
    ":20:pcs008bzmsgid-2\r\n" +
    ":23B:CRED\r\n" +
    ":32A:221020RON65784,32\r\n" +
    ":33B:RON65784,32\r\n" +
...
string finMessage_10621a_p008_C_D = "{1:F01GEBABEBBXXXX0000000000}{2:O1031055221020RZBRROBUXXXX00000000002210201055N}{3:{121:7a562c67-ca16-48ba-b074-65581be6f001}}{4:\r\n" +
    ":20:pcs008bzmsgid-3\r\n" +
    ":23B:CRED\r\n" +
    ":32A:221020RON65784,32\r\n" +
    ":33B:RON65784,32\r\n" +
