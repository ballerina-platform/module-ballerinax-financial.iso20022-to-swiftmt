...
isolated function testP241(xml mx, string mt) returns error? {
    ...
    test:assertEquals((check swiftmt:getFinMessage(rec)).toString(), mt, msg = "Use case p.2.4.1 result incorrect");
}
...
string finMessage_241_D_E = "{1:F01BANODKKKXXXX0000000000}{2:O9401200221020AAKRDK22XXXX00000000002210201200N}{4:\r\n" +
    ":20:100-01\r\n" +
    ":25:65479512\r\n" +
    ":28C:1001/1\r\n" +
...
string finMessage_241_C_D = "{1:F01BANODKKKXXXX0000000000}{2:O2020945221020AAKRDK22XXXX00000000002210200945N}{3:{121:7a562c67-ca16-48ba-b074-65581be6f001}}{4:\r\n" +
    ":20:pacs9bizmsgidr03\r\n" +
    ":21:pacs010EndToEnd+\r\n" +
    ":32A:221020DKK350000,\r\n" +
    ":52A:/87545213\r\n" +
